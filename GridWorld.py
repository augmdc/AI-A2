...
class GridWorld:
    ...
    def move_based_on_final_policy(self, values, rewards, actions, noise_prob, isMDP = True):
        ...
        if isMDP:
            ...
            final_policy_grid = ReinforcementLearning.final_policy(n, n, rewards, values, actions)
        ...
        if reward == GOLD_REWARD - 1:
            ...
            if isMDP:
                ...
                pass  # Need to initialize params for Q_learning globally, or move this block into ReinforcementLearning.py
#                values = ReinforcementLearning.Q_learning(world, rewards, episodes, gamma, min_epsilon, max_epsilon, alpha, living_reward, step_var)
        self.robot_pos = (x, y)
        self.grid[x][y] = 0  # Clear the cell after the robot moves
        self.score += reward
        return values
...
def main():
    ...
    q_values = ReinforcementLearning.Q_learning(world, rewards, episodes, gamma, min_epsilon, max_epsilon, alpha, living_reward, step_var)
    #q_values = QLearning.QLearning(rewards, ACTIONS, 100, alpha, max_epsilon)
