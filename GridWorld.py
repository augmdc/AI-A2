...
class GridWorld:
    ...
    def move_based_on_final_policy(self, world, values, rewards, actions, noise_prob, isMDP = True):
        """
    ...
    while running:
        ...
        if algorithm == 0:
            if move_counter >= move_delay:
                values = world.move_based_on_final_policy(world, values, rewards, ACTIONS, noise_prob)
        ...
        # Q-Learning Section
            ...
            if move_counter >= move_delay:
                q_values = world.move_based_on_final_policy(world, q_values, rewards, ACTIONS, noise_prob, False)
                move_counter = 0  # Reset the counter
                print(f"Current Score: {world.score}")
                # Check if the robot reached the goal
                if world.robot_pos == world.goal:
